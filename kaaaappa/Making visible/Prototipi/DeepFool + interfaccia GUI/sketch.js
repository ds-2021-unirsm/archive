...
let parametri = {
  ...
  EffettoToppa: false,
  SkinColorChange: function () {
    colorChange();
  },
  BackColorChange: function () {
    colorChangeBack();
  },
  Disegno: false,
  Negativo: false,
...
window.onload = function () {
  ...
  gui.add(parametri, "RefreshImage"); // Tendina: inserire array di valori
  gui.add(parametri, "EffettoToppa");
  gui.add(parametri, "Disegno");
  gui.add(parametri, "Negativo");
  gui.add(parametri, "Fiori"); //Spinta: non inserire nulla risponde al true/false.
  gui.add(parametri, "SkinColorChange");
  gui.add(parametri, "BackColorChange");
...
function draw() {
  ...
  if (parametri.Fiori) {
    ...
    parametri.EffettoToppa == false &&
    pix == 1
  ) {
    select("#status").html("Seleziona un effetto!");
    pix = 0;
  } else if (parametri.EffettoToppa == true && capezzolo == 0) {
    select("#status").html("Seleziona <br> il primo punto..");
  } else if (parametri.EffettoToppa == true && capezzolo == 1) {
    select("#status").html("Seleziona <br> il secondo punto..");
  } else if (parametri.EffettoToppa == true && capezzolo == 3) {
    select("#status").html("Sposta <br> il primo punto..");
  } else if (parametri.EffettoToppa == true && capezzolo == 4) {
  ...
  if (parametri.EffettoToppa == true && capezzolo == 2) {
    ...
    toppa();
  } else if (parametri.EffettoToppa == true && capezzolo == 5) {
    toppa();
  } else if (parametri.EffettoToppa == false && capezzolo == 6) {
    refresh_immagine();
    capezzolo = 0;
  }
...
function mousePressed() {
  ...
  if (parametri.EffettoToppa == true && capezzolo == 0) {
    cxDx = mouseX;
    cyDx = mouseY;
    capezzolo = 1;
  } else if (parametri.EffettoToppa == true && capezzolo == 1) {
