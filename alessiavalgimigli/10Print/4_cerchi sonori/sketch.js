...
function draw() {
  ...
  if (random(1) > 0.5) {
    ...
    stroke(r, g, b, 50);
    ellipse(x, y, spacing.value());
    //la frequenza viene definita da 440 (frequenza che identifica il LA) moltiplicata dalla y dell'elemento, il tutto diviso dal valore dato dallo splider dello spazio
